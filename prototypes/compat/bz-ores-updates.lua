...
if mods["bzcarbon"] and mods["space-age"] then
  if settings.startup["bzcarbon-enable-flake-graphite"].value then
    if settings.startup["crushing-industry-byproducts"].value then
    ...
    frep.add_result("carbonic-asteroid-crushing", CrushingIndustry.make_crushing_byproduct("flake-graphite", CrushingIndustry.FREQUENT_BYPRODUCT, 3, true), false, 2)
  end
end

...
if mods["planet-muluna"] then
  ...
  if data.raw["assembling-machine"]["crusher-2"] then
    ...
    if settings.startup["crushing-industry-space-crusher-quality"].value then
      data.raw["assembling-machine"]["crusher-2"].effect_receiver = {base_effect={quality=0.2, productivity=0.25}}
      ...
      data.raw["assembling-machine"]["crusher-2"].energy_usage = "1620kW"
    end

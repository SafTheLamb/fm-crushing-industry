		...
		data:extend({
			{
				...
				icon_size = 256,
				effects = {
					-- Filled in with CrushingIndustry.add_smelting_productivity
				},
			...
			{
				type = "technology",
				name = "crushed-ore-smelting-productivity-4",
				icons = util.technology_icon_constant_recipe_productivity("__crushing-industry__/graphics/technology/crushed-ore-smelting-productivity.png"),
				icon_size = 256,
				effects = {
					-- Filled in with CrushingIndustry.add_smelting_productivity
				},
				prerequisites = {"crushed-ore-smelting-productivity-3"},
				unit = {
			...
			data:extend({
				{
					...
					iicon_size = 256,
					effects = {
						-- Filled in with CrushingIndustry.add_molten_productivity
					},
